import "./style.css";
import { createCharacterList } from "./charactersList";

const charactersTemplates = createCharacterList();
...
const cardJoffrey = `
      <li class="character col">
        <div class="card character__card">
          ...
          <div class="card-body">
            <h2 class="character__name card-title h4">${charactersTemplates[0].name} ${charactersTemplates[0].family}</h2>
            ...
            <div class="character__overlay">
              <ul class="list-unstyled">
                <li>Años de reinado: ${charactersTemplates[0].reignLength}</li>
              </ul>
...
const cardJamie = `
 <li class="character col">
        <div class="card character__card">
          ...
          <div class="card-body">
            <h2 class="character__name card-title h4"> ${charactersTemplates[1].name} ${charactersTemplates[2].family}</h2>
            <div class="character__info">
              <ul class="list-unstyled">
...
const cardDaenerys = `<li class="character col">
        <div class="card character__card">
          ...
          <div class="card-body">
            <h2 class="character__name card-title h4">${charactersTemplates[2].name} ${charactersTemplates[2].family}</h2>
            <div class="character__info">
              <ul class="list-unstyled">
...
const cardTyrion = `<li class="character col">
        <div class="card character__card">
          ...
          <div class="card-body">
            <h2 class="character__name card-title h4">${charactersTemplates[3].name} ${charactersTemplates[0].family}</h2>
            <div class="character__info">
              <ul class="list-unstyled">
...
const cardBron = `<li class="character col">
        <div class="card character__card">
          ...
          <div class="card-body">
            <h2 class="character__name card-title h4">${charactersTemplates[4].name} ${charactersTemplates[0].family}</h2>
            <div class="character__info">
              <ul class="list-unstyled">
